...
from openood.networks import ResNet18_32x32, ResNet18_224x224, ResNet50, ViT_B_16
...
parser.add_argument('--postprocessor', default='linear')
parser.add_argument('--preprocessor', default='base')
parser.add_argument(
    '--id-data',
    type=str,
    default='cifar10',
...
for subfolder in sorted(glob(os.path.join(root, 's*'))):
    ...
    evaluator = Evaluator(
        ...
        preprocessor=preprocessor_name,  # default preprocessing
